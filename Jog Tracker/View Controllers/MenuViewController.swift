...
class MenuViewController: UIViewController {
    ...
    override func viewDidLayoutSubviews() {
        ...
        jogsButton.snp.makeConstraints {
            (make) in
            make.edges.equalTo(view).inset(UIEdgeInsets(top: 183, left: 103, bottom: 333, right: 103))
        }
        ...
        infoButton.snp.makeConstraints {
            (make) in
            make.edges.equalTo(view).inset(UIEdgeInsets(top: 233, left: 103, bottom: 273, right: 103))
        }
        ...
        contactButton.snp.makeConstraints {
            (make) in
            make.edges.equalTo(view).inset(UIEdgeInsets(top: 293, left: 103, bottom: 223, right: 103))
        }
        ...
        closeButton.snp.makeConstraints {
            (make) in
            make.edges.equalTo(view).inset(UIEdgeInsets(top: 28, left: 329, bottom: 618, right: 25))
        }
        ...
        logoImageView.snp.makeConstraints {
            (make) in
            make.edges.equalTo(view).inset(UIEdgeInsets(top: 20, left: 25, bottom: 610, right: 252))
        }
